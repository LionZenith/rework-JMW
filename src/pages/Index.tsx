...
import { Menu, X, Instagram, Mail, ChevronDown, Facebook } from "lucide-react";
...
const ACHIEVEMENTS = [
  {
    ...
    detail: "Qualifikation fürs Mehrkampf-Finale",
  },
  {
    year: "2024",
    title: "Nationale Meisterin",
    detail: "Schwebebalken & Boden",
  },
  {
    year: "2024",
    title: "Weltcup-Serie",
    detail: "Top 15 — Cottbus, Deutschland",
  },
  {
    year: "2023",
    title: "Europäische Jugendspiele",
    detail: "Vertretung Liechtensteins",
  },
  {
    year: "2023",
    title: "Nationaler Rekord",
    detail: "Höchste Mehrkampf-Punktzahl aller Zeiten",
  },
  {
    year: "2022",
    title: "Jugend-Europameisterschaften",
    detail: "Bestes Ergebnis für Liechtenstein",
  },
];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.h2
                variants={fadeUp}
                custom={1}
                className="font-display text-4xl lg:text-5xl font-light text-foreground"
              >
                Anmut trifft{" "}
                <span className="italic font-medium text-accent-red">
                  Entschlossenheit
                </span>
              </motion.h2>
              <motion.p
              ...
              >
                Aufgewachsen in Liechtenstein, setzt Julia Weissenhofer seit
                ihrem sechsten Lebensjahr neue Massstäbe im Kunstturnen. Als
                Vertreterin einer der kleinsten Nationen Europas auf der
                Weltbühne bringt sie unerschütterliches Engagement und eine
                tiefe Leidenschaft für ihren Sport mit.
              </motion.p>
              <motion.p
                variants={fadeUp}
                custom={3}
                className="font-body text-base leading-relaxed text-muted-foreground"
              >
                Julia trainiert in Schaan und ist spezialisiert auf
                Schwebebalken und Bodenturnen — eine Verbindung aus technischer
                Präzision und künstlerischem Ausdruck. Ihr Ziel: das Kunstturnen
                Liechtensteins auf die internationale Landkarte zu setzen.
              </motion.p>
              <motion.div
                variants={fadeUp}
                custom={4}
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          ...
          >
            <motion.p
              variants={fadeUp}
              custom={0}
              className="font-body text-xs tracking-[0.3em] uppercase text-accent-red"
            >
              Karriere-Highlights
            </motion.p>
            <motion.h2
              variants={fadeUp}
              custom={1}
              className="font-display text-4xl lg:text-5xl font-light mt-3 text-accent-gold"
            >
              Erfolge
            </motion.h2>
          </motion.div>
          ...
          <div className="space-y-0">
            {ACHIEVEMENTS.map((a, i) => (
              ...
              >
                <span className="font-display text-2xl font-light text-destructive">
                  {a.year}
                </span>
                <span className="font-display text-lg md:text-xl text-primary-foreground">
                  {a.title}
                </span>
                <span className="font-body text-sm text-primary-foreground/50 hidden md:block">
                  {a.detail}
                </span>
              </motion.div>
            ))}
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              custom={1}
              className="font-display text-4xl lg:text-5xl font-light text-foreground mt-3"
            >
              Aus dem Blog
            </motion.h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Vorbereitung auf die EM 2025",
                date: "Feb 2025",
                excerpt:
                  "Mein Trainingsweg hin zum grössten Wettkampf des Jahres...",
              },
              {
                title: "Ein Tag in meinem Leben",
                date: "Jan 2025",
                excerpt:
                  "Wie ein typischer Trainingstag zwischen Halle und Schule aussieht...",
              },
              {
                title: "Rückblick auf 2024",
                date: "Dez 2024",
                excerpt:
                  "Ein Jahr voller Wachstum, Herausforderungen und unvergesslicher Momente...",
              },
            ].map((post, i) => (
              <motion.article
                key={i}
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              custom={2}
              className="font-body text-base mt-6 leading-relaxed max-w-lg mx-auto text-destructive-foreground"
            >
              Sei Teil von Julias Reise! Tritt dem Fanclub bei und erhalte
              exklusive Updates, Einblicke hinter die Kulissen und frühzeitigen
              Zugang zu Wettkampfplänen.
            </motion.p>
            <motion.a
              variants={fadeUp}
              custom={3}
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              custom={1}
              className="font-display text-3xl font-light text-foreground mt-3"
            >
              Partner
            </motion.h2>
          </motion.div>
      ...
      <section id="sponsoring" className="py-16 lg:py-20 bg-muted/50">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          <h2 className="font-display text-3xl font-light text-foreground mt-3">
            Sponsoring
          </h2>
          <p className="font-body text-sm text-muted-foreground mt-4 leading-relaxed max-w-lg mx-auto">
            Interesse, Julias sportliche Karriere zu unterstützen? Melde dich,
            um Partnerschaftsmöglichkeiten und Sponsoring-Pakete zu besprechen.
          </p>
          <a
            href="mailto:kunstturnen@julia-weissenhofer.li"
      ...
      <footer className="py-6 border-t border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="font-display text-sm text-muted-foreground">
            © 2026 Julia Weissenhofer
          </span>
          <div className="flex items-center gap-6">
            <a
              href="https://www.instagram.com/julia_weissenhofer/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61568196463529"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-accent-red transition-colors"
            >
