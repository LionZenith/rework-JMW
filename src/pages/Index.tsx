...
import hiltiLogo from "@/assets/sponsors/hilti.png";
import locLogo from "@/assets/sponsors/loc.png";
import vpbankLogo from "@/assets/sponsors/vpbank.png";
import ivoclarLogo from "@/assets/sponsors/ivoclar.png";
import hovalLogo from "@/assets/sponsors/hoval.png";
import ospeltLogo from "@/assets/sponsors/ospelt.png";

const NAV_ITEMS = ["Über mich", "Erfolge", "Blog", "Fanclub", "Partner", "Sponsoring"];

const ACHIEVEMENTS = [
  { year: "2025", title: "Europameisterschaften", detail: "Qualifikation für das Mehrkampffinale" },
  { year: "2024", title: "Nationalmeisterin", detail: "Schwebebalken & Boden" },
  { year: "2024", title: "Weltcup-Serie", detail: "Top 15 — Cottbus, Deutschland" },
  { year: "2023", title: "Europäische Jugendolympiade", detail: "Vertretung Liechtensteins" },
  { year: "2023", title: "Nationalrekord", detail: "Höchste Mehrkampfwertung der Geschichte" },
  { year: "2022", title: "Junioren-Europameisterschaften", detail: "Bestes Ergebnis für Liechtenstein" },
];

const PARTNERS = [
  { name: "Hilti Foundation", logo: hiltiLogo },
  { name: "Liechtenstein Olympic Committee", logo: locLogo },
  { name: "VP Bank", logo: vpbankLogo },
  { name: "Ivoclar", logo: ivoclarLogo },
  { name: "Hoval", logo: hovalLogo },
  { name: "Ospelt Group", logo: ospeltLogo },
];
...
const Index = () => {
  ...
  const sectionId = (label: string) =>
    label.toLowerCase().replace(/ü/g, "u").replace(/ /g, "-");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-16">
          <a href="#" className="flex items-center gap-2">
            <img src={silhouette} alt="" className="h-7 w-7 object-contain" />
          ...
          <div className="hidden md:flex items-center gap-8">
            {NAV_ITEMS.map((item) => (
              <a
                key={item}
                href={`#${sectionId(item)}`}
                className="font-body text-xs tracking-widest uppercase text-muted-foreground hover:text-accent transition-colors duration-300"
              >
                {item}
              </a>
            ))}
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          >
            Julia
            <br />
            <span className="font-semibold text-accent">Weissenhofer</span>
          </motion.h1>
          <motion.div
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
      ...
      {/* Über mich */}
      <section id="uber-mich" className="py-24 lg:py-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                ...
                className="w-full max-w-md mx-auto aspect-[3/4] object-cover object-top rounded-sm shadow-2xl"
              />
            </motion.div>
            <motion.div
              initial="hidden"
            ...
            >
              ...
              <motion.h2 variants={fadeUp} custom={1} className="font-display text-4xl lg:text-5xl font-light text-foreground">
                Anmut trifft <span className="italic font-medium">Entschlossenheit</span>
              </motion.h2>
              <motion.p variants={fadeUp} custom={2} className="font-body text-base leading-relaxed text-muted-foreground">
                In Liechtenstein geboren und aufgewachsen, bewegt Julia Weissenhofer seit ihrem
                sechsten Lebensjahr die Grenzen des Kunstturnens. Als Vertreterin einer der
                kleinsten Nationen Europas auf der internationalen Bühne bringt sie ein
                unerschütterliches Engagement für Exzellenz und eine tiefe Leidenschaft für
                ihren Sport mit.
              </motion.p>
              <motion.p variants={fadeUp} custom={3} className="font-body text-base leading-relaxed text-muted-foreground">
                Julia trainiert in Schaan und ist spezialisiert auf Schwebebalken und Boden —
                eine Kombination aus technischer Präzision und künstlerischem Ausdruck. Ihr
                Ziel: das Kunstturnen Liechtensteins auf die internationale Landkarte zu setzen.
              </motion.p>
      ...
      {/* Erfolge */}
      <section id="erfolge" className="py-24 lg:py-32 bg-primary">
      ...
      {/* Partner */}
      <section id="partner" className="py-20 lg:py-24">
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            {PARTNERS.map((p, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="flex flex-col items-center gap-2 grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-300"
              >
                <img
                  src={p.logo}
                  alt={p.name}
      ...
      <section id="sponsoring" className="py-16 lg:py-20 bg-muted/50">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="font-body text-sm text-muted-foreground mt-4 leading-relaxed max-w-lg mx-auto">
            Interesse, Julias sportliche Karriere zu unterstützen? Melden Sie sich,
